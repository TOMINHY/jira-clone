...
export const requestCreateProjectCategory = (data) => {
...
export const requestGetProjectDetail = (data) => {
  const token = localStorage.getItem(TOKEN);
...
export const requestUpdateProject = (data) => {
  const token = localStorage.getItem(TOKEN);
...
export const requestGetTaskDetail = (data) => {
  const token = localStorage.getItem(TOKEN);
...
export const requestUpdateTaskInfo = (data) => {
  const token = localStorage.getItem(TOKEN);
  return http.get(`/Project/createTask`, data, {
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
